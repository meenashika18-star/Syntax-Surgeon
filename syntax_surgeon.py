...
Original file is located at
    https://colab.research.google.com/drive/1tI6QxYxRJu0K_yM9zaGD5imcQ4ND_CCY
"""
...
def download_pdf():
    ...
    try:
        ...
        # Add each message with HTML cleaning and page breaks
        for i, msg in enumerate(conversation_history, 1):
            role = msg['role'].upper()
            content_text = msg['content']
...
status_message, file_path = download_pdf()
...
# Example of adding an assistant message
assistant_msg = {"role": "assistant", "content": "I'm doing well, thank you! How can I help you today?"}
